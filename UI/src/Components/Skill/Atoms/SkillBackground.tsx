...
export function SkillBackground({ windowWidth, windowHeight }: SkillBackgroundProps) {
	...
	return <div style={divStyle} className="c2-skills-background absolute top-0 left-0 -z-10" />;
}
